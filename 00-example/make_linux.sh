...
cp $(command -v node) server-mcp-weather

# Inject el blob script en el binario de node
npx postject server-mcp-weather NODE_SEA_BLOB main.blob --sentinel-fuse NODE_SEA_FUSE_fce680ab2cc467b6e072b8b5df1996b2